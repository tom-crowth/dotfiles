...
-- define some custom functions to bind
...
vim.keymap.set('n', '<leader>re', builtin.registers, { desc = 'List available [CC]omamnds' })
vim.keymap.set('n', '<leader>cc', builtin.commands, { desc = 'List available [CC]omamnds' })
